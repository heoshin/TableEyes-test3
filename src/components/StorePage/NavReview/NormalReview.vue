  ...
  <div class="reviewBox">
    ...
    <div class="mainreview-rating">
      <div class="mainreview-text">
        <p class="MRT-text">
          사용자의 리뷰가 들어갈 곳 입니다.사용자의 리뷰가 들어갈 곳
          입니다사용자의 리뷰가 들어갈 곳 입니다사용자의 리뷰가 들어갈 곳
          입니다사용자의 리뷰가 들어갈 곳 입니다사용자의 리뷰가 들어갈 곳
          입니다사용자의 리뷰가 들어갈 곳 입니다사용자의 리뷰가 들어갈 곳
        </p>
      </div>
...
.MRT-name:before {
  ...
  background-image: url("../../../assets/img/review-smile.png");
